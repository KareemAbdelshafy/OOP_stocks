 ...
 */
public class CostAnalysisInvestment extends AbstractCommand {
   ...
   */
  public CostAnalysisInvestment(Appendable appendable,
                                PortfolioAdvanced portfolio, Scanner scanner) {
